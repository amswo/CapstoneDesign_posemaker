 ...
 */
public class CRobot_BluetoothService2 {
    // Debugging
     ...
     */
    public CRobot_BluetoothService2(Context context, Handler handler) {
    ...
    private class AcceptThread extends Thread {
        ...
        public void run() {
            ...
            while (mState != STATE_CONNECTED) {
                ...
                if (socket != null) {
                    synchronized (CRobot_BluetoothService2.this) {
                        switch (mState) {
                            case STATE_LISTEN:
    ...
    private class ConnectThread extends Thread {
        ...
        public void run() {
            ...
            try {
                ...
                CRobot_BluetoothService2.this.start();
                return;
            }
